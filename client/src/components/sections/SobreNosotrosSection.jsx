    ...
    <section className="min-h-screen pt-24 pb-16 flex items-center justify-center">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <p className="font-script text-cafe-cream text-2xl sm:text-3xl mb-2">{st('about_subtitle', 'nosotros_subtitle')}</p>
          <h2 className="font-display text-3xl sm:text-4xl text-cafe-text">{st('about_title', 'nosotros_heading')}</h2>
