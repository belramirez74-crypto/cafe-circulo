      ...
      <div className="relative z-10 text-center px-4 max-w-4xl pt-24 pb-12">
        {settings?.hero_subtitle && (
          <motion.p
            ...
            className={`font-display text-[#5c1514] text-base sm:text-lg mb-3 tracking-widest uppercase font-semibold ${light ? 'drop-shadow-[0_0_14px_rgba(255,255,255,0.35)]' : 'drop-shadow-[0_0_14px_rgba(0,0,0,0.7)]'}`}
          >
            {settings.hero_subtitle}
          </motion.p>
        )}
