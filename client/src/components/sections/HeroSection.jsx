    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-16">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl pt-24 pb-12">
        ...
        >
          ...
          <br />
          <span className="font-script text-[#5c1514] text-6xl sm:text-8xl inline-block drop-shadow-[0_4px_20px_rgba(92,21,20,1)] animate-fade-in-up" style={{ fontWeight: 600 }}>
