  ...
  return (
    <div className="min-h-screen pt-20 pb-16 bg-cafe-bg">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-[#2a1514] border border-[#5c1514]/30 p-8 space-y-6 rounded-xl shadow-lg shadow-black/5">
        ...
        <div className="mt-8">
          ...
          {autoFavorites.length === 0 ? (
            <div className="bg-[#2a1514] border border-[#5c1514]/30 p-8 rounded-xl text-center shadow-lg shadow-black/5">
            ...
            <div className="space-y-3">
              {autoFavorites.map((item, i) => (
                <div key={i} className="bg-[#2a1514] border border-[#5c1514]/30 p-4 rounded-xl flex items-center gap-4 shadow-lg shadow-black/5 hover:border-[#5c1514]/50 transition-shadow">
          ...
          <AnimatePresence>
            {showAddPin && (
              <motion.div
                ...
                className="bg-[#2a1514] border border-[#5c1514]/30 p-4 rounded-xl mb-4 overflow-hidden shadow-lg shadow-black/5"
              >
                <input
                  value={searchPin}
          ...
          {pinnedFavorites.length === 0 && !showAddPin ? (
            ...
            <div className="space-y-3">
              {pinnedFavorites.map(fav => {
                ...
                return (
                  <div key={fav.id} className="bg-[#2a1514] border border-[#5c1514]/30 p-4 rounded-xl flex items-center gap-4 shadow-lg shadow-black/5 hover:border-[#5c1514]/50 transition-shadow">
